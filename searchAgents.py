...
A* search (astar), run the following command:
...
class SearchAgent(Agent):
    ...
    As a default, this agent solves a PositionSearchProblem to find location (1,1)
...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState):
        ...
        self.start = (self.startingPosition, tuple(self.corners)) # the starting position of the Pacman and a list of the remaining corners that must be reached
    ...
    def getStartState(self):
        ...
        """
        "*** YOUR CODE HERE ***"
        return self.start # returns just the starting position of the Pacman
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not hitsWall:
                if (nextx, nexty) in remaining_corners:
                    new_remaining_corners = tuple(corner for corner in remaining_corners if corner != (nextx, nexty))
                else:
                    new_remaining_corners = remaining_corners
                successors.append((((nextx, nexty), new_remaining_corners), action, 1))
...
def cornersHeuristic(state, problem):
    ...
    return total_manhattan_dist # Default to trivial solution
...
def foodHeuristic(state, problem):
    ...
    "*** YOUR CODE HERE (COMP/ELEC 557 ONLY) ***"
    return 0